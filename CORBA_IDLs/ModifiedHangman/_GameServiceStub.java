...
public class _GameServiceStub extends org.omg.CORBA.portable.ObjectImpl implements ModifiedHangman.GameService
{
  ...
  public ModifiedHangman.Player getPlayerByUsername (String username, String token) throws ModifiedHangman.PlayerNotLoggedInException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getPlayerByUsername", true);
                ...
                return getPlayerByUsername (username, token        );
            } finally {
                _releaseReply ($in);
            }
  } // getPlayerByUsername
