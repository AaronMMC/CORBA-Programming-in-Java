 ...
 implements ModifiedHangman.GameServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("start_game", new java.lang.Integer (1));
    _methods.put ("guessLetter", new java.lang.Integer (2));
    _methods.put ("get_leaderboard", new java.lang.Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // ModifiedHangman/GameService/start_game
       {
         try {
       ...
       case 2:  // ModifiedHangman/GameService/guessLetter
       {
         try {
           String username = in.read_string ();
       ...
       case 3:  // ModifiedHangman/GameService/get_leaderboard
       {
         try {
           String token = in.read_string ();
